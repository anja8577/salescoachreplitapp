...
Generated by SSA Behavior Assessment Tool`;
  ...
  const generatePDF = async () => {
    try {
      ...
      pdf.setFontSize(16);
      const headerText = `Selling Skills Assessment Report for ${user.fullName} on ${new Date().toLocaleDateString()} ${new Date().toLocaleTimeString()}`;
      ...
      pdf.setFontSize(12);
      pdf.text(`Overall Score: Level ${currentScore.toFixed(1)} / 4`, 20, 95);
      ...
      steps.forEach((step, stepIndex) => {
        ...
        pdf.text(`Level ${stepLevel.toFixed(1)}`, 160, yPosition + 3);
