      ...
      <div className="max-w-md mx-auto px-4 pt-12">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Button
            ...
            className="h-24 flex flex-col items-center justify-center space-y-2 bg-[#11339b] text-white hover:bg-purple-800 border-2 border-[#11339b] hover:border-purple-800"
            size="lg"
          >
            <History size={24} />
